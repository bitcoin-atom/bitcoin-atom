...
const char * const BITCOIN_CONF_FILENAME = "atom.conf";
const char * const BITCOIN_PID_FILENAME = "atom.pid";
...
const CLogCategoryDesc LogCategories[] =
{
    ...
    {BCLog::STAKEMODIFIER, "stakemodifier"},
    {BCLog::COINAGE, "coinage"},
    {BCLog::ALL, "1"},
    {BCLog::ALL, "all"},
};
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\BitcoinAtom
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\BitcoinAtom
    // Mac: ~/Library/Application Support/BitcoinAtom
    // Unix: ~/.bitcoinatom
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BitcoinAtom";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BitcoinAtom";
#else
    // Unix
    return pathRet / ".bitcoinatom";
#endif
#endif
}
